...
class NUFFT:
    ...
    # import cpu codes
    from ._nufft_class_methods_cpu import (
        _init__cpu,
        _plan_cpu,
        _precompute_sp_cpu,
        _solve_cpu,
    ...
    # import device codes
    from ._nufft_class_methods_device import (
        _init__device,
        _plan_device,
        _set_wavefront_device,
        _offload_device,
        to_device,
        to_host,
        _x2xx_device,
    ...
    from ._nufft_class_methods_cpu import (
        _k2y_legacy_host,
        _y2k_legacy_host,
        _selfadjoint_legacy_host,
        _forward_legacy_host,
        _adjoint_legacy_host,
        _solve_legacy_host,
    )
    ...
    def __del__(self):
        if self.processor in ["hsa", "hsa_legacy"]:
            self.release()
        else:
            pass
